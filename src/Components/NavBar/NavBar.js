...
// React Icons
import { SiPhpmyadmin , SiAcademia } from "react-icons/si";
...
const NavBar = () => {
  ...
  return (
    <>
      {/* TopNav */}
      <div
        className={`fixed top-0 inset-x-0 flex justify-between items-center bg-zinc-800 py-3 px-5 transition-all z-10 ${
              ...
              <>
                <li>
                  <NavLink
                    ...
                    className="flex items-center text-white text-sm py-3 px-2 my-1 rounded-xl hover:bg-gray-700"
                  >
                    <MdOutlineCategory className="mx-2 text-2xl" />
                    {hamBurger ? null : "Portal"}
                  </NavLink>
                </li>
              </>
            )}            
